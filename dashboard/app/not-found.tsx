    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] w-full">
            ...
            <div className="mt-8 space-y-2 text-center">
                <h1 className="text-6xl font-bold tracking-tight bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent animate-gradient-x font-grift">
                    404
                </h1>
                <h3 className="text-4xl font-bold tracking-tight font-manrope">Page Not Found</h3>
