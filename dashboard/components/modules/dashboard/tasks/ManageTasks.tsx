...
export default function ManageTasks({ data, meta }: ManageTasksProps) {
  ...
  return (
    <div className="space-y-6">
      <TableToolbar searchPlaceholder="Search tasks..." filters={filters}>
        <Button
          size="sm"
      ...
      <div className="space-y-4">
        <DataTable
          columns={columns}
          data={data}
          rowIdAccessor={(row: ITask) => row.id}
          enableRowDrag={true}
